...
def draw_relationship(self,img,entity1_center,entity2_center,text1_shape,text2_shape,label1,label2):
    ...
    textbox_background_list = [(0, 180, 0), (180, 0, 0), (180, 100, 0), (100, 0, 180), (0, 100, 180)]
    self.textbox_background = random.choice(textbox_background_list)

    text_color_list = [(0, 0, 0), (0, 240, 0), (240, 0, 0), (240, 240, 0), (0, 240, 240), (240, 0, 240)]
...
class copy_thread(threading.Thread):
    ...
    def run(self):
        ...
        font_style_list = [cv2.FONT_HERSHEY_SIMPLEX, cv2.QT_FONT_NORMAL, cv2.FONT_HERSHEY_TRIPLEX, cv2.FONT_HERSHEY_DUPLEX]
        ...
        textbox_background_list=[(0,180,0),(180,0,0),(180,100,0),(100,0,180),(0,100,180)]
        # self.textbox_background = (0,0,180)
        self.textbox_background = random.choice(textbox_background_list)
